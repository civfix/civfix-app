...
import { View, Pressable, TextInput, StyleSheet, ActivityIndicator, Platform, type ViewStyle } from "react-native"
...
import { Avatar, FollowButton, VerifiedBadge, EmptyState, LoadingState } from "../primitives"
      ...
      >
        ...
        <View style={styles.meta}>
          <View style={styles.nameRow}>
            ...
            {person.verified ? <VerifiedBadge size="sm" /> : null}
          </View>
          {person.handle ? (
