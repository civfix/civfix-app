/**
 * shouldOfferChannelSkip - the one pure rule behind NewChannelBody's header "Skip" control.
 *
 ...
 *
 * Extracted (and unit-tested) rather than inlined so the invariant "Skip is never a mislabeled Create"
 * is pinned by a test, matching the other pure wizard predicates in ./channelWizard.
 */
