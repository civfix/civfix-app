/**
 * buildLocalReplyTo: the PURE optimistic reply-preview builder for `useChat.send`.
 *
 ...
 * strip paints immediately, with no round trip. The server echo replaces the whole message on ack, bringing
 ...
 * always false because you can only reply to a message that exists right now.
 */
