 ...
 *
 * THE PROBLEM IT SOLVES. `shell/PageStack.native` keeps every page on the stack MOUNTED so a pop can
 ...
 * sheet, the expanded panel, the web overlay, the /bodies gallery, a unit test), and for all of them "the
 * body I mounted is the active one" is simply correct. So only PageStack.native provides a value, and
 * nothing else in the tree changes behaviour by a byte.
 *
