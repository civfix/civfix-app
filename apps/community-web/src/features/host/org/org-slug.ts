 ...
 * lowercase kebab-case, ASCII letters and digits only, 3-40 characters. Accented letters are folded to
 * their base letter first so "Café Río" becomes "cafe-rio" rather than "caf-r-o". The result may still
 * be too SHORT to be valid (a one-letter name); callers validate with `orgSlugProblem` before use.
 */
