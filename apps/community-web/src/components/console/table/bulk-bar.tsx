...
export function BulkBar({ count, actions, onClear, className }: BulkBarProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "fixed bottom-token-4 left-1/2 z-console-bulk-bar flex max-w-[calc(100vw-theme(spacing.token-8))] -translate-x-1/2 items-center gap-token-2 overflow-x-auto rounded-md border border-console-line bg-console-surface px-token-3 py-token-2 shadow-console-3",
